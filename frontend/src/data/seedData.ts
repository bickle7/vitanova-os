...
export const SEED_WORDS: Word[] = [
  ...
  // ── AT A BAR ─────────────────────────────────────────────────────────────
  { id: seedId('bar', 0),  english: 'A pint',              spanish: 'Una pinta',           pronunciation: 'OO-na PEEN-ta',              category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 1),  english: 'Draught beer',        spanish: 'Cerveza de barril',   pronunciation: 'ther-VE-tha de ba-RREEL',    category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 2),  english: 'Another round',       spanish: 'Otra ronda',          pronunciation: 'OH-tra RON-da',              category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 3),  english: 'Gin and tonic',       spanish: 'Gin tonic',           pronunciation: 'gin TO-nik',                 category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 4),  english: 'Rum and Coke',        spanish: 'Ron con Cola',        pronunciation: 'ron kon KO-la',              category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 5),  english: 'Vodka tonic',         spanish: 'Vodka con tónica',    pronunciation: 'VOD-ka kon TO-nee-ka',       category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 6),  english: 'Sangria',             spanish: 'Sangría',             pronunciation: 'san-GREE-a',                 category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 7),  english: 'Olives',              spanish: 'Aceitunas',           pronunciation: 'ah-they-TOO-nas',            category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 8),  english: 'Nuts',                spanish: 'Cacahuetes',          pronunciation: 'ka-ka-WE-tes',               category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 9),  english: 'Tinto de verano',     spanish: 'Tinto de verano',     pronunciation: 'TEEN-to de ve-RA-no',        category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 10), english: 'Cider',               spanish: 'Sidra',               pronunciation: 'SEE-dra',                    category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 11), english: 'Cava / Sparkling',    spanish: 'Cava',                pronunciation: 'KA-ba',                      category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 12), english: 'The tab / bill',      spanish: 'La cuenta',           pronunciation: 'la KWEN-ta',                 category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 13), english: 'Cocktail',            spanish: 'Cóctel',              pronunciation: 'KOK-tel',                    category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 14), english: 'Shot',                spanish: 'Chupito',             pronunciation: 'choo-PEE-to',                category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 15), english: 'Cheers!',             spanish: '¡Salud!',             pronunciation: 'sa-LOOD',                    category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 16), english: 'Ice',                 spanish: 'Hielo',               pronunciation: 'YE-lo',                      category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 17), english: 'Lemon',               spanish: 'Limón',               pronunciation: 'lee-MON',                    category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 18), english: 'Mixer / tonic',       spanish: 'Tónica',             pronunciation: 'TO-nee-ka',                  category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('bar', 19), english: 'Happy hour',          spanish: 'Hora feliz',          pronunciation: 'OH-ra fe-LEES',              category: 'bar', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },

  // ── HEALTH / PHARMACY ────────────────────────────────────────────────────
  { id: seedId('health', 0),  english: 'Headache',         spanish: 'Dolor de cabeza',       pronunciation: 'do-LOR de ka-BE-tha',         category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 1),  english: 'Fever',            spanish: 'Fiebre',                pronunciation: 'FYE-bre',                     category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 2),  english: 'Sore throat',      spanish: 'Dolor de garganta',     pronunciation: 'do-LOR de gar-GAN-ta',        category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 3),  english: 'Stomach ache',     spanish: 'Dolor de estómago',     pronunciation: 'do-LOR de es-TO-ma-go',       category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 4),  english: 'Painkiller',       spanish: 'Analgésico',            pronunciation: 'ah-nal-HE-see-ko',            category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 5),  english: 'Antibiotic',       spanish: 'Antibiótico',           pronunciation: 'an-tee-BYO-tee-ko',           category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 6),  english: 'Prescription',     spanish: 'Receta médica',         pronunciation: 're-THE-ta ME-dee-ka',         category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 7),  english: 'Allergy',          spanish: 'Alergia',               pronunciation: 'ah-LER-hya',                  category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 8),  english: 'Plasters',         spanish: 'Tiritas',               pronunciation: 'tee-REE-tas',                 category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 9),  english: 'Diarrhoea',        spanish: 'Diarrea',               pronunciation: 'dya-RRE-a',                   category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 10), english: 'Sunstroke',        spanish: 'Insolación',            pronunciation: 'een-so-la-THYON',             category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 11), english: 'Insect bite',      spanish: 'Picadura de insecto',   pronunciation: 'pee-ka-DOO-ra de een-SEK-to', category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 12), english: 'Ibuprofen',        spanish: 'Ibuprofeno',            pronunciation: 'ee-boo-pro-FE-no',            category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 13), english: 'Antacid',          spanish: 'Antiácido',             pronunciation: 'an-tee-AH-thee-do',           category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 14), english: 'Nausea',           spanish: 'Náuseas',               pronunciation: 'NOW-se-as',                   category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('health', 15), english: 'I have a rash',    spanish: 'Tengo sarpullido',      pronunciation: 'TEN-go sar-poo-YEE-do',       category: 'health', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },

  // ── AT THE BEACH ─────────────────────────────────────────────────────────
  { id: seedId('beach', 0),  english: 'Sunbed',            spanish: 'Tumbona',              pronunciation: 'toom-BO-na',                  category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 1),  english: 'Parasol / Shade',   spanish: 'Sombrilla',            pronunciation: 'som-BREE-ya',                 category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 2),  english: 'Sunscreen',         spanish: 'Protector solar',      pronunciation: 'pro-tek-TOR so-LAR',          category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 3),  english: 'Towel',             spanish: 'Toalla',               pronunciation: 'to-AH-ya',                    category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 4),  english: 'Lifeguard',         spanish: 'Socorrista',           pronunciation: 'so-ko-RREES-ta',              category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 5),  english: 'The sea',           spanish: 'El mar',               pronunciation: 'el mar',                      category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 6),  english: 'Sand',              spanish: 'Arena',                pronunciation: 'ah-RE-na',                    category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 7),  english: 'Waves',             spanish: 'Olas',                 pronunciation: 'OH-las',                      category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 8),  english: 'Jet ski',           spanish: 'Moto acuática',        pronunciation: 'MO-to ah-KWA-tee-ka',         category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 9),  english: 'Pedalo',            spanish: 'Patín de agua',        pronunciation: 'pa-TEEN de AH-gwa',           category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 10), english: 'Shower',            spanish: 'Ducha',                pronunciation: 'DOO-cha',                     category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 11), english: 'Changing room',     spanish: 'Vestuario',            pronunciation: 'ves-TWAR-yo',                 category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 12), english: 'Shade',             spanish: 'Sombra',               pronunciation: 'SOM-bra',                     category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 13), english: 'High tide',         spanish: 'Marea alta',           pronunciation: 'ma-RE-a AL-ta',               category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 14), english: 'Low tide',          spanish: 'Marea baja',           pronunciation: 'ma-RE-a BA-ha',               category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
  { id: seedId('beach', 15), english: 'Water sports',      spanish: 'Deportes acuáticos',   pronunciation: 'de-POR-tes ah-KWA-tee-kos',   category: 'beach', is_favourite: false, use_count: 0, source: 'discovery', created_at: '' },
]
...
export const CONNECTORS: Record<QuickTapContext, Connector[]> = {
  ...
  cafe: [
    { english: 'Can I get...', spanish: '¿Me pone...' },
    { english: "I'd like...", spanish: 'Quisiera...' },
    { english: 'Do you have...?', spanish: '¿Tiene...?' },
    { english: 'What\'s the WiFi password?', spanish: '¿Cuál es la contraseña del WiFi?' },
    { english: 'For here please', spanish: 'Para tomar aquí, por favor' },
    { english: 'To take away please', spanish: 'Para llevar, por favor' },
    { english: 'The bill please', spanish: 'La cuenta, por favor' },
  ],
  bar: [
    { english: 'Can I get...', spanish: '¿Me pone...' },
    { english: "I'd like...", spanish: 'Quisiera...' },
    { english: 'Same again please', spanish: 'Lo mismo, por favor' },
    { english: 'A round of...', spanish: 'Una ronda de...' },
    { english: 'What do you recommend?', spanish: '¿Qué recomienda?' },
    { english: 'The tab please', spanish: 'La cuenta, por favor' },
    { english: 'No ice please', spanish: 'Sin hielo, por favor' },
  ],
  doctors: [
    { english: 'I need to see a doctor', spanish: 'Necesito ver a un médico' },
    { english: 'I have...', spanish: 'Tengo...' },
    { english: 'I need...', spanish: 'Necesito...' },
    { english: "I'm allergic to...", spanish: 'Soy alérgico a...' },
    { english: 'Where is the nearest pharmacy?', spanish: '¿Dónde está la farmacia más cercana?' },
    { english: 'Do you have something for...?', spanish: '¿Tiene algo para...?' },
    { english: 'I feel unwell', spanish: 'Me siento mal' },
  ],
  beach: [
    { english: 'Where can I hire...?', spanish: '¿Dónde puedo alquilar...?' },
    { english: 'How much is...?', spanish: '¿Cuánto cuesta...?' },
    { english: 'Is it safe to swim?', spanish: '¿Es seguro nadar aquí?' },
    { english: 'I need...', spanish: 'Necesito...' },
    { english: 'Where is...?', spanish: '¿Dónde está...?' },
    { english: 'Can I book...?', spanish: '¿Puedo reservar...?' },
  ],
  small_talk: [
    ...
    { english: 'The weather is...', spanish: 'El tiempo está...' },
    { english: 'Do you like...?', spanish: '¿Te gusta...?' },
    { english: 'It was lovely to meet you', spanish: 'Ha sido un placer conocerte' },
  ],
}
...
export const CONNECTOR_SMART_WORDS: Record<string, SmartWord[]> = {
  ...
  // ── CAFÉ ─────────────────────────────────────────────────────────────────
  'cafe:¿Me pone...': [
    { id: 'csw_cafe_0', english: 'a coffee',          spanish: 'un café' },
    { id: 'csw_cafe_1', english: 'a white coffee',    spanish: 'un café con leche' },
    { id: 'csw_cafe_2', english: 'a cortado',         spanish: 'un cortado' },
    { id: 'csw_cafe_3', english: 'a decaf',           spanish: 'un descafeinado' },
    { id: 'csw_cafe_4', english: 'an orange juice',   spanish: 'un zumo de naranja' },
    { id: 'csw_cafe_5', english: 'a tea',             spanish: 'un té' },
    { id: 'csw_cafe_6', english: 'a hot chocolate',   spanish: 'un chocolate caliente' },
    { id: 'csw_cafe_7', english: 'a glass of water',  spanish: 'un vaso de agua' },
  ],
  'cafe:Quisiera...': [
    { id: 'csw_cafe_8',  english: 'a coffee',          spanish: 'un café' },
    { id: 'csw_cafe_9',  english: 'a croissant',       spanish: 'un cruasán' },
    { id: 'csw_cafe_10', english: 'a pastry',          spanish: 'un bollo' },
    { id: 'csw_cafe_11', english: 'a sandwich',        spanish: 'un bocadillo' },
    { id: 'csw_cafe_12', english: 'some toast',        spanish: 'una tostada' },
    { id: 'csw_cafe_13', english: 'an ice cream',      spanish: 'un helado' },
  ],
  'cafe:¿Tiene...?': [
    { id: 'csw_cafe_14', english: 'oat milk',          spanish: 'leche de avena' },
    { id: 'csw_cafe_15', english: 'decaf',             spanish: 'descafeinado' },
    { id: 'csw_cafe_16', english: 'sugar',             spanish: 'azúcar' },
    { id: 'csw_cafe_17', english: 'outdoor seating',   spanish: 'terraza' },
    { id: 'csw_cafe_18', english: 'WiFi',              spanish: 'WiFi' },
  ],

  // ── BAR ──────────────────────────────────────────────────────────────────
  'bar:¿Me pone...': [
    { id: 'csw_bar_0', english: 'a pint',              spanish: 'una pinta' },
    { id: 'csw_bar_1', english: 'a gin and tonic',     spanish: 'un gin tonic' },
    { id: 'csw_bar_2', english: 'a rum and Coke',      spanish: 'un ron con Cola' },
    { id: 'csw_bar_3', english: 'a glass of wine',     spanish: 'un vaso de vino' },
    { id: 'csw_bar_4', english: 'a beer',              spanish: 'una cerveza' },
    { id: 'csw_bar_5', english: 'a sparkling wine',    spanish: 'un cava' },
    { id: 'csw_bar_6', english: 'a shot',              spanish: 'un chupito' },
  ],
  'bar:Quisiera...': [
    { id: 'csw_bar_7',  english: 'a pint of draught',  spanish: 'una pinta de barril' },
    { id: 'csw_bar_8',  english: 'something cold',     spanish: 'algo frío' },
    { id: 'csw_bar_9',  english: 'a recommendation',   spanish: 'una recomendación' },
    { id: 'csw_bar_10', english: 'a cocktail',         spanish: 'un cóctel' },
    { id: 'csw_bar_11', english: 'a sangria',          spanish: 'una sangría' },
  ],
  'bar:Una ronda de...': [
    { id: 'csw_bar_12', english: 'beers',              spanish: 'cervezas' },
    { id: 'csw_bar_13', english: 'gin and tonics',     spanish: 'gin tonics' },
    { id: 'csw_bar_14', english: 'wines',              spanish: 'vinos' },
    { id: 'csw_bar_15', english: 'shots',              spanish: 'chupitos' },
  ],

  // ── DOCTORS / PHARMACY ───────────────────────────────────────────────────
  'doctors:Tengo...': [
    { id: 'csw_doc_0', english: 'a headache',          spanish: 'dolor de cabeza' },
    { id: 'csw_doc_1', english: 'a fever',             spanish: 'fiebre' },
    { id: 'csw_doc_2', english: 'a sore throat',       spanish: 'dolor de garganta' },
    { id: 'csw_doc_3', english: 'a stomach ache',      spanish: 'dolor de estómago' },
    { id: 'csw_doc_4', english: 'a rash',              spanish: 'sarpullido' },
    { id: 'csw_doc_5', english: 'diarrhoea',           spanish: 'diarrea' },
    { id: 'csw_doc_6', english: 'nausea',              spanish: 'náuseas' },
    { id: 'csw_doc_7', english: 'sunstroke',           spanish: 'insolación' },
  ],
  'doctors:Necesito...': [
    { id: 'csw_doc_8',  english: 'a doctor',           spanish: 'un médico' },
    { id: 'csw_doc_9',  english: 'a prescription',     spanish: 'una receta' },
    { id: 'csw_doc_10', english: 'painkillers',        spanish: 'analgésicos' },
    { id: 'csw_doc_11', english: 'antibiotics',        spanish: 'antibióticos' },
    { id: 'csw_doc_12', english: 'plasters',           spanish: 'tiritas' },
    { id: 'csw_doc_13', english: 'ibuprofen',          spanish: 'ibuprofeno' },
    { id: 'csw_doc_14', english: 'an antacid',         spanish: 'un antiácido' },
  ],
  'doctors:¿Tiene algo para...?': [
    { id: 'csw_doc_15', english: 'a headache',         spanish: 'el dolor de cabeza' },
    { id: 'csw_doc_16', english: 'a cold',             spanish: 'el resfriado' },
    { id: 'csw_doc_17', english: 'sunburn',            spanish: 'la quemadura solar' },
    { id: 'csw_doc_18', english: 'insect bites',       spanish: 'las picaduras de insecto' },
    { id: 'csw_doc_19', english: 'an upset stomach',   spanish: 'el malestar estomacal' },
  ],

  // ── BEACH ────────────────────────────────────────────────────────────────
  'beach:¿Dónde puedo alquilar...?': [
    { id: 'csw_beach_0', english: 'a sunbed',          spanish: 'una tumbona' },
    { id: 'csw_beach_1', english: 'a parasol',         spanish: 'una sombrilla' },
    { id: 'csw_beach_2', english: 'a jet ski',         spanish: 'una moto acuática' },
    { id: 'csw_beach_3', english: 'a pedalo',          spanish: 'un patín de agua' },
    { id: 'csw_beach_4', english: 'a snorkel',         spanish: 'un equipo de snorkel' },
  ],
  'beach:¿Cuánto cuesta...?': [
    { id: 'csw_beach_5', english: 'a sunbed',          spanish: 'una tumbona' },
    { id: 'csw_beach_6', english: 'a parasol',         spanish: 'una sombrilla' },
    { id: 'csw_beach_7', english: 'a jet ski per hour', spanish: 'una moto acuática por hora' },
  ],
  'beach:Necesito...': [
    { id: 'csw_beach_8',  english: 'sunscreen',        spanish: 'protector solar' },
    { id: 'csw_beach_9',  english: 'a towel',          spanish: 'una toalla' },
    { id: 'csw_beach_10', english: 'shade',            spanish: 'sombra' },
    { id: 'csw_beach_11', english: 'a shower',         spanish: 'una ducha' },
  ],
  'beach:¿Dónde está...?': [
    { id: 'csw_beach_12', english: 'the shower',       spanish: 'la ducha' },
    { id: 'csw_beach_13', english: 'the lifeguard',    spanish: 'el socorrista' },
    { id: 'csw_beach_14', english: 'the changing room', spanish: 'el vestuario' },
    { id: 'csw_beach_15', english: 'the nearest bar',  spanish: 'el bar más cercano' },
  ],

  // ── SMALL TALK ───────────────────────────────────────────────────────────
  'small_talk:¿De dónde eres?': [
    { id: 'csw_talk_0', english: 'England',             spanish: 'Inglaterra' },
    { id: 'csw_talk_1', english: 'Scotland',            spanish: 'Escocia' },
    { id: 'csw_talk_2', english: 'Wales',               spanish: 'Gales' },
    { id: 'csw_talk_3', english: 'Ireland',             spanish: 'Irlanda' },
  ],
  'small_talk:Soy de...': [
    { id: 'csw_talk_4', english: 'England',             spanish: 'Inglaterra' },
    { id: 'csw_talk_5', english: 'Scotland',            spanish: 'Escocia' },
    { id: 'csw_talk_6', english: 'Leeds',               spanish: 'Leeds' },
    { id: 'csw_talk_7', english: 'London',              spanish: 'Londres' },
    { id: 'csw_talk_8', english: 'Manchester',          spanish: 'Mánchester' },
  ],
  'small_talk:El tiempo está...': [
    { id: 'csw_talk_9',  english: 'beautiful',          spanish: 'precioso' },
    { id: 'csw_talk_10', english: 'very hot',           spanish: 'muy caluroso' },
    { id: 'csw_talk_11', english: 'perfect',            spanish: 'perfecto' },
    { id: 'csw_talk_12', english: 'a bit cloudy',       spanish: 'un poco nublado' },
  ],
  'small_talk:¿Te gusta...?': [
    { id: 'csw_talk_13', english: 'Spain',              spanish: 'España' },
    { id: 'csw_talk_14', english: 'the food here',      spanish: 'la comida de aquí' },
    { id: 'csw_talk_15', english: 'the weather',        spanish: 'el tiempo' },
    { id: 'csw_talk_16', english: 'football',           spanish: 'el fútbol' },
  ],
}
